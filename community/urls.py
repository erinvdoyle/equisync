...
from .announcements.views import submit_announcement, edit_announcement, delete_announcement
...
urlpatterns = [
    ...
    path('announcements/edit/', announcement_views.edit_announcement, name='edit_announcement'),
    path('announcements/edit/<int:announcement_id>/', announcement_views.edit_announcement, name='edit_announcement_with_id'),
    path('announcements/delete/<int:announcement_id>/', announcement_views.delete_announcement, name='delete_announcement'),
]
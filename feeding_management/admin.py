...
class FeedingChartAdmin(admin.ModelAdmin):
    ...
    search_fields = ('horse__name', 'breakfast_feed', 'lunch_feed', 'dinner_feed', 'supplements', 'medicines')
    ...
    def approve_selected_plans(self, request, queryset):
        ...
        self.message_user(request, f"{updated_count} feeding plan(s) approved.")
